...
@endif
			...
			<ul class="nl_nav_ul">
				...
				<a href="{{url('counter/counterWeight.html')}}" target="_blank"><li> 标准体重计算 </li></a>
				<a href="#" target="_blank"><li> 热量查询 </li></a>
			</ul>
		</div>
	</div>
</div>
	        ...
	        <div id="doc-oc-demo1" class="am-offcanvas" >
	          <div class="am-offcanvas-bar nl_nav_mobile_container_background">
				...
				<ul class="am-list am-list-self admin-sidebar-list" id="collapase-nav-1">
				  ...
				  <li  class="am-panel">
				    <a  href="{{url('counter/counterWeight.html')}}" target="_blank"><i class="am-icon-home am-margin-left-sm"></i> 标准体重计算</a>
				  </li>

				  <li  class="am-panel">
				    <a  href="#" target="_blank"><i class="am-icon-home am-margin-left-sm"></i> 热量查询</a>
				  </li>
